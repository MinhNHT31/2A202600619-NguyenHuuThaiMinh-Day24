...
def pii_scan(text: str, analyzer=None, anonymizer=None) -> dict:
    ...
    # Filter out false positives from spaCy English model on Vietnamese text
...
async def check_input_rail(text: str, rails=None) -> dict:
    ...
    refuse_keywords = ["xin lỗi", "không thể", "không được phép", "i cannot", "i'm sorry", "chặn"]
...
if __name__ == "__main__":
    ...
    report_data = {
        "adversarial_suite": {
            ...
            "passed": passed,
            "pass_rate": passed / len(adversarial_set) if len(adversarial_set) > 0 else 0.0,
            "details": results
        },
        "latency": latency
    }
    ...
    print("Saved reports/guard_results.json successfully!")
